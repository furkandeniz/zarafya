                                ...
                                <div class="row g-2">
                                    <div class="col-6">
                                        <input type="number" name="min_shipping_days" min="1" max="365"
                                               ...
                                               value="{{ old('min_shipping_days', $product->min_shipping_days) }}" placeholder="En az (ör. 1)">
                                    ...
                                    <div class="col-6">
                                        <input type="number" name="max_shipping_days" min="1" max="365"
                                               ...
                                               value="{{ old('max_shipping_days', $product->max_shipping_days) }}" placeholder="En çok (ör. 3)">
