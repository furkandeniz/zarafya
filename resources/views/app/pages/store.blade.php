...
{{-- Mağaza Başlık Bandı --}}
<div style="background:#2f2f2f;padding:48px 0 36px;">
    <div class="container">
        <div class="d-flex flex-column flex-md-row align-items-center align-items-md-start gap-4">
            ...
            @if ($store->logo)
                <img src="{{ asset('storage/' . $store->logo) }}"
                     alt="{{ $store->name }}"
                     style="width:88px;height:88px;object-fit:cover;border-radius:14px;border:3px solid rgba(255,255,255,0.12);flex-shrink:0;">
            @else
                <div style="width:88px;height:88px;border-radius:14px;background:#3b5d50;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:32px;font-weight:800;color:#fff;">
            ...
            <div class="flex-grow-1">
                ...
                @if ($store->description)
                    <p style="font-size:14px;color:rgba(255,255,255,0.65);margin-bottom:14px;max-width:620px;line-height:1.6;">
                        {{ $store->description }}
                    </p>
                @endif
                ...
                @if ($store->email)
                    <div style="font-size:13px;color:rgba(255,255,255,0.55);">
                        <i class="fas fa-envelope me-1" style="color:#3b5d50;"></i>{{ $store->email }}
                    </div>
                @endif
            </div>
